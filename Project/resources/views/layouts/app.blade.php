...
<head>
    ...
    <style>
        ...
        /* ══════════════════ UNIFORM 65% TRANSLUCENCY GLASSMORPHISM (LIGHT MODE) ══════════════════ */
        /* Base Body & Container Foundations */
        html:not(.dark) body {
            background-color: #F8FAFC !important;
            color: #111827 !important;
        ...
        /* Light Mode Uniform 65% Frosted Glass Cards & Containers */
        html:not(.dark) .card-tilt,
        html:not(.dark) .card-tilt-3d,
        html:not(.dark) .career-card,
        html:not(.dark) .multimedia-card,
        html:not(.dark) .resource-card,
        html:not(.dark) .story-card,
        ...
        html:not(.dark) .bg-white\/95 {
            ...
            box-shadow: 0 20px 50px -10px rgba(30, 40, 70, 0.07), inset 0 1px 0 rgba(255, 255, 255, 0.90) !important;
        }
        ...
        html:not(.dark) .multimedia-card:hover,
        html:not(.dark) .resource-card:hover,
        html:not(.dark) .story-card:hover,
        html:not(.dark) .quiz-card:hover,
        ...
        html:not(.dark) .grid > div[class*="rounded-3xl"]:hover {
            ...
            border: 1px solid rgba(118, 87, 255, 0.35) !important;
            transform: translate3d(0, -3px, 0);
            box-shadow: 0 24px 60px -10px rgba(30, 40, 70, 0.12), inset 0 1px 0 rgba(255, 255, 255, 1) !important;
        }
        ...
        /* Preserve Intentional White Text on Buttons & Modals */
        ...
        html:not(.dark) footer .font-display,
        ...
        html.dark .filter-box, .dark .filter-box,
        html.dark .main-section-box, .dark .main-section-box,
        html.dark .dashboard-container, .dark .dashboard-container,
        html.dark .careers-container, .dark .careers-container,
        html.dark .multimedia-container, .dark .multimedia-container,
        html.dark .stories-container, .dark .stories-container,
        html.dark .quiz-container, .dark .quiz-container,
        html.dark .auth-card, .dark .auth-card,
        html.dark .sitemap-container, .dark .sitemap-container,
        html.dark .profile-container, .dark .profile-container,
        html.dark .resume-container, .dark .resume-container,
        html.dark .dashboard-banner, .dark .dashboard-banner,
        html.dark [data-section-wrapper], .dark [data-section-wrapper],
        ...
        html.dark .bg-\[\#060913\], .dark .bg-\[\#060913\],
        html.dark .bg-\[\#070b14\], .dark .bg-\[\#070b14\],
        html.dark .bg-\[\#0b0f19\], .dark .bg-\[\#0b0f19\],
        html.dark .bg-\[\#090d18\], .dark .bg-\[\#090d18\],
        html.dark .bg-\[\#070a13\], .dark .bg-\[\#070a13\],
        html.dark .bg-\[\#0c111e\], .dark .bg-\[\#0c111e\],
        html.dark .bg-\[\#0a0f1d\], .dark .bg-\[\#0a0f1d\],
        html.dark .dark\:bg-\[\#080B12\], .dark .dark\:bg-\[\#080B12\],
        html.dark .dark\:bg-\[\#060913\], .dark .dark\:bg-\[\#060913\],
        ...
        html.dark .track-wrapper, .dark .track-wrapper,
        html.dark .quiz-question-container, .dark .quiz-question-container,
        html.dark .feedback-card, .dark .feedback-card,
        html.dark .command-tile, .dark .command-tile,
        ...
        html.dark .multimedia-card:hover, .dark .multimedia-card:hover,
        html.dark .resource-card:hover, .dark .resource-card:hover,
        html.dark .story-card:hover, .dark .story-card:hover,
        html.dark .quiz-card:hover, .dark .quiz-card:hover,
...
<body class="min-h-screen flex flex-col antialiased transition-colors duration-500 relative overflow-x-hidden bg-[#F8FAFC] dark:bg-[#030508] text-[#111827] dark:text-[#f8fafc]">
    ...
    <script>
        ...
        function toggleBookmark(event, itemId, itemType = 'career') {
            ...
            showBookmarkNotification(nextState ? 'Saved to your Career Passport bookmarks!' : 'Removed from bookmarks.');
        ...
        window.showBookmarkNotification = showBookmarkNotification;
    </script>
