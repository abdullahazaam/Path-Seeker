...
<div class="min-h-[70vh] flex items-center justify-center px-4 py-16">
    <div class="max-w-md w-full text-center space-y-6 p-8 rounded-3xl bg-white/90 dark:bg-slate-900/70 backdrop-blur-2xl border border-rose-500/30 shadow-2xl">
