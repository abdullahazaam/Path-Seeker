...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 pb-16 space-y-8">
                    ...
                    @if(count($skills) > 0)
                        <div class="pt-2 space-y-1.5">
                            <div class="text-[10px] uppercase tracking-wider font-bold text-slate-500 dark:text-slate-400 font-mono flex items-center gap-1.5">
                                <i class="fa-solid fa-layer-group text-cyan-500 text-[10px]"></i>
                                <span>Core Tech Stack &amp; Competencies:</span>
                            </div>
                            <div class="flex flex-wrap gap-1.5">
                                @foreach(array_slice($skills, 0, 6) as $sk)
                                    <span class="px-2.5 py-1 text-xs font-medium rounded-lg bg-slate-100 dark:bg-white/[0.04] text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-white/10 font-mono">
                                        {{ $sk }}
                                    </span>
                                @endforeach
                            </div>
