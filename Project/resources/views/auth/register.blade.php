...
<section class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-12">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
        ...
        <div class="lg:col-span-6 space-y-8 text-center lg:text-left">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-2 text-left">
                <div class="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-white/10 shadow-sm hover:border-purple-500/30 transition-all backdrop-blur-xl group">
                    ...
                    <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-1 line-clamp-2">Tailored dashboard for Students, Graduates, or Pros.</p>
                </div>
                ...
                <div class="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-white/10 shadow-sm hover:border-purple-500/30 transition-all backdrop-blur-xl group">
                    ...
                    <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-1 line-clamp-2">Interactive 5-stage career milestones and tracking.</p>
                </div>
                ...
                <div class="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-white/10 shadow-sm hover:border-purple-500/30 transition-all backdrop-blur-xl group">
                    ...
                    <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-1 line-clamp-2">Instant access to 15+ curated PDF cheatsheets &amp; videos.</p>
                </div>
            </div>
        ...
        <div class="lg:col-span-6 flex justify-center">
            <div class="relative w-full max-w-xl bg-white/90 dark:bg-slate-900/60 backdrop-blur-2xl border border-slate-200/80 dark:border-white/10 shadow-2xl dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] rounded-3xl p-6 sm:p-8 overflow-hidden">
                    ...
                    <div class="flex items-center justify-between pb-1">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <h2 class="text-lg font-black text-slate-900 dark:text-white font-display leading-tight">Create Career Passport</h2>
                            </div>
                        </div>
                    ...
                    <form action="{{ url('/register') }}" method="POST" class="space-y-3.5">
                        ...
                        <div class="pt-2">
                            <button type="submit" class="btn-sweep group w-full py-3.5 rounded-full font-black text-sm text-white bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:via-purple-500 hover:to-pink-500 shadow-neon-purple hover:shadow-neon-pink transition-all duration-300 flex items-center justify-center gap-2 hover:scale-[1.02] cursor-pointer">
                                ...
                                <span class="text-white font-black">Register &amp; Enter Passport</span>
