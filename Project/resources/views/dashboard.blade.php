        ...
        <div class="lg:col-span-6 rounded-3xl p-7 sm:p-8 bg-white dark:bg-[#080B12] border border-slate-200 dark:border-white/10 shadow-2xl flex flex-col justify-between space-y-6">
            <div class="space-y-1.5">
                <div class="flex items-center justify-between">
                    ...
                    <span class="px-2 py-0.5 rounded-full text-[9px] font-mono font-bold bg-purple-500/15 text-purple-600 dark:text-purple-300 border border-purple-500/20">
                        Tag &amp; Skill Synergy
                    </span>
                </div>
            ...
            @if(isset($suggestedCareers) && $suggestedCareers->isNotEmpty())
                <div class="space-y-3">
                    @foreach($suggestedCareers->take(3) as $sCareer)
                        <a href="{{ route('careers.show', $sCareer->id) }}" class="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200/80 dark:border-white/5 hover:border-purple-500/40 hover:bg-purple-50/50 dark:hover:bg-purple-950/20 transition-all group">
                            <div class="flex items-center gap-3 min-w-0">
                                <div class="w-9 h-9 rounded-xl bg-purple-500/10 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400 flex items-center justify-center text-xs shrink-0 group-hover:scale-105 transition-transform">
                                    <i class="fa-solid fa-sparkles"></i>
                                </div>
                                <div class="min-w-0">
                                    <div class="flex items-center gap-2">
                                        <h4 class="text-xs font-bold text-slate-900 dark:text-white truncate group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors font-display">{{ $sCareer->title }}</h4>
                            ...
                            <div class="text-right shrink-0 pl-3">
                                <div class="text-xs font-black text-purple-600 dark:text-purple-400 font-mono">{{ $sCareer->expected_salary }}</div>
                                <div class="text-[9px] text-slate-400 flex items-center justify-end gap-1">
                                    <span>Discover</span>
                                    <i class="fa-solid fa-arrow-right text-[8px] group-hover:translate-x-0.5 transition-transform"></i>
                                </div>
            ...
            <div class="pt-2 border-t border-slate-200/80 dark:border-white/5 flex items-center justify-between text-xs">
                <a href="{{ route('quiz.index') }}" class="text-purple-600 dark:text-purple-400 font-bold hover:underline inline-flex items-center gap-1.5">
