        ...
        <div class="space-y-4 relative z-10">
            @forelse($featuredCareers as $career)
                ...
                <div class="career-card career-stagger-card relative p-6 sm:p-7 rounded-3xl bg-slate-50/80 dark:bg-[#0b0f19] border border-slate-200/90 dark:border-white/10 hover:border-cyan-500/50 hover:bg-slate-100/90 dark:hover:bg-[#0e1424] shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group overflow-hidden"
                     style="animation-delay: {{ min($loop->index * 70, 700) }}ms;">
                    {{-- Ambient Hover Glow --}}
        ...
        <div class="relative flex flex-col rounded-3xl overflow-hidden border border-slate-200/80 dark:border-white/10 bg-white dark:bg-[#080B12] shadow-2xl dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.37)]">
            ...
            <div class="divide-y divide-slate-200/80 dark:divide-white/[0.05] flex-1 p-2 sm:p-3">
                @forelse($featuredMultimedia as $media)
                    <div class="p-4 rounded-2xl flex items-center justify-between gap-4 hover:bg-slate-100/80 dark:hover:bg-white/[0.04] transition-all group media-stagger-card"
                         style="animation-delay: {{ min($loop->index * 70, 700) }}ms;">
        ...
        <div class="relative flex flex-col rounded-3xl overflow-hidden border border-slate-200/80 dark:border-white/10 bg-white dark:bg-[#080B12] shadow-2xl dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.37)]">
            ...
            <div class="divide-y divide-slate-200/80 dark:divide-white/[0.05] flex-1 p-2 sm:p-3">
                @forelse($featuredResources as $res)
                    <div class="p-4 rounded-2xl flex items-center justify-between gap-4 hover:bg-slate-100/80 dark:hover:bg-white/[0.04] transition-all group resource-stagger-card"
                         style="animation-delay: {{ min($loop->index * 70, 700) }}ms;">
                        <div class="flex items-center gap-3.5 min-w-0">
