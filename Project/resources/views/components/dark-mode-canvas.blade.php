{{-- ══════════════════ DEDICATED DARK MODE HTML5 CANVAS 3D BACKGROUND COMPONENT ══════════════════ --}}
{{-- High-Performance 60FPS WebGL/Canvas Engine: Luminous Digital Rain, 3D Particle Wave & Floating Bubbles --}}
...
(function() {
    ...
    function initRain() {
        ...
        for (let i = 0; i < RAIN_COUNT; i++) {
            rainDrops.push({
                ...
                color: Math.random() > 0.45 ? '#12CFF3' : '#7657FF',
                r: Math.random() > 0.45 ? 18 : 118,
                g: Math.random() > 0.45 ? 207 : 87,
                b: Math.random() > 0.45 ? 243 : 255,
    ...
    function draw(now) {
        ...
        // 1. Semi-transparent Black Base for Motion Blur / Trailing Effect
